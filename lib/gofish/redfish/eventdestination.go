...
func GetEventDestination(c common2.Client, uri string) (*EventDestination, error) {
	// validate uri
...
func DeleteEventDestination(c common2.Client, uri string) (err error) {
	// validate uri
	if strings.TrimSpace(uri) == "" {
		return fmt.Errorf("uri should not be empty")
	}
...
func ListReferencedEventDestinations(c common2.Client, link string) ([]*EventDestination, error) { //nolint:dupl
