...
func GetMemoryDomain(c common2.Client, uri string) (*MemoryDomain, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedMemoryDomains(c common2.Client, link string) ([]*MemoryDomain, error) { //nolint:dupl
