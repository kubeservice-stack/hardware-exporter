...
func GetVirtualMedia(c common2.Client, uri string) (*VirtualMedia, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedVirtualMedias(c common2.Client, link string) ([]*VirtualMedia, error) { //nolint:dupl
