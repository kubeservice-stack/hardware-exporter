...
type ComputerSystem struct {
	...
	IndicatorLED common2.IndicatorLED
...
func (computersystem *ComputerSystem) UnmarshalJSON(b []byte) error {
	...
	var t struct {
		...
		Actions            CSActions
		Bios               common2.Link
		Processors         common2.Link
		Memory             common2.Link
		EthernetInterfaces common2.Link
		SimpleStorage      common2.Link
		SecureBoot         common2.Link
		Storage            common2.Link
		Storages           common2.Link
		NetworkInterfaces  common2.Link
		LogServices        common2.Link
		MemoryDomains      common2.Link
		PCIeDevices        common2.Links
		PCIeFunctions      common2.Links
		Links              CSLinks
	}
	...
	*computersystem = ComputerSystem(t.temp)
	...
	computersystem.storages = string(t.Storages)
...
func GetComputerSystem(c common2.Client, uri string) (*ComputerSystem, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedComputerSystems(c common2.Client, link string) ([]*ComputerSystem, error) {
...
type CSLinks struct {
	...
	// ComputerSystem.
	ConsumingComputerSystems common2.Links
	...
	SupplyingComputerSystems common2.Links
