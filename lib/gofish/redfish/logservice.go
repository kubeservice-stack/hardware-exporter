...
func GetLogService(c common2.Client, uri string) (*LogService, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedLogServices(c common2.Client, link string) ([]*LogService, error) { //nolint:dupl
