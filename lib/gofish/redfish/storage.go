...
func GetStorage(c common2.Client, uri string) (*Storage, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
// reference.
func ListReferencedStorages(c common2.Client, link string) ([]*Storage, error) { //nolint:dupl
	var result []*Storage
	if link == "" {
		return result, nil
	}
...
func (storage *Storage) GetOperationApplyTimeValues() ([]common2.OperationApplyTime, error) {
...
type StorageController struct {
	...
	Identifiers []common2.Identifier
	// Location shall contain location information of the
	// associated storage controller.
	Location common2.Location
	...
	SupportedControllerProtocols []common2.Protocol
	...
	SupportedDeviceProtocols []common2.Protocol
...
func GetStorageController(c common2.Client, uri string) (*StorageController, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedStorageControllers(c common2.Client, link string) ([]*StorageController, error) { //nolint:dupl
