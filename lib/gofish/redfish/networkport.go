...
func GetNetworkPort(c common2.Client, uri string) (*NetworkPort, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedNetworkPorts(c common2.Client, link string) ([]*NetworkPort, error) { //nolint:dupl
