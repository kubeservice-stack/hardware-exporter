...
func GetManagerAccount(c common2.Client, uri string) (*ManagerAccount, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedManagerAccounts(c common2.Client, link string) ([]*ManagerAccount, error) { //nolint:dupl
