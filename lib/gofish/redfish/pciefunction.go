...
func (pciefunction *PCIeFunction) UnmarshalJSON(b []byte) error {
	...
	type links struct {
		...
		EthernetInterfaces          common2.Links
		...
		StorageControllers          common2.Links
...
func GetPCIeFunction(c common2.Client, uri string) (*PCIeFunction, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedPCIeFunctions(c common2.Client, link string) ([]*PCIeFunction, error) { //nolint:dupl
