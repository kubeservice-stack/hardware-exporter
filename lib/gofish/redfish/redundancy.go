...
func GetRedundancy(c common2.Client, uri string) (*Redundancy, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedRedundancies(c common2.Client, link string) ([]*Redundancy, error) { //nolint:dupl
