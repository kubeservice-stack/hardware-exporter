...
func GetMemoryMetrics(c common2.Client, uri string) (*MemoryMetrics, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedMemoryMetricss(c common2.Client, link string) ([]*MemoryMetrics, error) { //nolint:dupl
