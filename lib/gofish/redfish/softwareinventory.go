...
func GetSoftwareInventory(c common2.Client, uri string) (*SoftwareInventory, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedSoftwareInventories(c common2.Client, link string) ([]*SoftwareInventory, error) { //nolint:dupl
