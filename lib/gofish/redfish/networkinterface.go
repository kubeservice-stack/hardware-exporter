...
func GetNetworkInterface(c common2.Client, uri string) (*NetworkInterface, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedNetworkInterfaces(c common2.Client, link string) ([]*NetworkInterface, error) { //nolint:dupl
