...
func GetSimpleStorage(c common2.Client, uri string) (*SimpleStorage, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedSimpleStorages(c common2.Client, link string) ([]*SimpleStorage, error) { //nolint:dupl
