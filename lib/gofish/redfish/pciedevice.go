...
func GetPCIeDevice(c common2.Client, uri string) (*PCIeDevice, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedPCIeDevices(c common2.Client, link string) ([]*PCIeDevice, error) { //nolint:dupl
