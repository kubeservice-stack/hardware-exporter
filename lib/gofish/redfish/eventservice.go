...
func GetEventService(c common2.Client, uri string) (*EventService, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedEventServices(c common2.Client, link string) ([]*EventService, error) { //nolint:dupl
