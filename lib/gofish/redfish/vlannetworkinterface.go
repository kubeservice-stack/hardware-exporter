...
func GetVLanNetworkInterface(c common2.Client, uri string) (*VLanNetworkInterface, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedVLanNetworkInterfaces(c common2.Client, link string) ([]*VLanNetworkInterface, error) { //nolint:dupl
