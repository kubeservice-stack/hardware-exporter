...
func AllowedVolumesUpdateApplyTimes(c common2.Client, link string) ([]common2.OperationApplyTime, error) {
	resp, err := c.Get(link)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
	var temp struct {
		OperationApplyTimeSupport common2.OperationApplyTimeSupport `json:"@Redfish.OperationApplyTimeSupport"`
	}
	...
	var applyTimes []common2.OperationApplyTime
