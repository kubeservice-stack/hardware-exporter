...
func GetSecureBoot(c common2.Client, uri string) (*SecureBoot, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedSecureBoots(c common2.Client, link string) ([]*SecureBoot, error) { //nolint:dupl
