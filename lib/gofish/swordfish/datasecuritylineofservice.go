...
func GetDataSecurityLineOfService(c common2.Client, uri string) (*DataSecurityLineOfService, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedDataSecurityLineOfServices(c common2.Client, link string) ([]*DataSecurityLineOfService, error) {
