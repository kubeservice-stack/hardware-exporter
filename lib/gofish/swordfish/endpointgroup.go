...
func GetEndpointGroup(c common2.Client, uri string) (*EndpointGroup, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedEndpointGroups(c common2.Client, link string) ([]*EndpointGroup, error) { //nolint:dupl
