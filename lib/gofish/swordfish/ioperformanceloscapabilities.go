...
func GetIOPerformanceLoSCapabilities(c common2.Client, uri string) (*IOPerformanceLoSCapabilities, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedIOPerformanceLoSCapabilitiess(c common2.Client, link string) ([]*IOPerformanceLoSCapabilities, error) { //nolint:dupl
