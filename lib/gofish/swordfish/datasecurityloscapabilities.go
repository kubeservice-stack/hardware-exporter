...
func GetDataSecurityLoSCapabilities(c common2.Client, uri string) (*DataSecurityLoSCapabilities, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedDataSecurityLoSCapabilities(c common2.Client, link string) ([]*DataSecurityLoSCapabilities, error) { //nolint:dupl
