...
func GetDataStorageLoSCapabilities(c common2.Client, uri string) (*DataStorageLoSCapabilities, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedDataStorageLoSCapabilities(c common2.Client, link string) ([]*DataStorageLoSCapabilities, error) { //nolint:dupl
