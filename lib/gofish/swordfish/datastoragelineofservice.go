...
func GetDataStorageLineOfService(c common2.Client, uri string) (*DataStorageLineOfService, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedDataStorageLineOfServices(c common2.Client, link string) ([]*DataStorageLineOfService, error) { //nolint:dupl
