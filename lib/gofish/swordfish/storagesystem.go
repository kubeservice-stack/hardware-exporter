...
func GetStorageSystem(c common2.Client, uri string) (*StorageSystem, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedStorageSystems(c common2.Client, link string) ([]*StorageSystem, error) {
