...
type IOConnectivityLineOfService struct {
	...
	AccessProtocols []common2.Protocol
...
func GetIOConnectivityLineOfService(c common2.Client, uri string) (*IOConnectivityLineOfService, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedIOConnectivityLineOfServices(c common2.Client, link string) ([]*IOConnectivityLineOfService, error) { //nolint:dupl
