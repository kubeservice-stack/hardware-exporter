...
func GetFileShare(c common2.Client, uri string) (*FileShare, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
// reference.
func ListReferencedFileShares(c common2.Client, link string) ([]*FileShare, error) {
