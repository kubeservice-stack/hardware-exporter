...
func GetIOPerformanceLineOfService(c common2.Client, uri string) (*IOPerformanceLineOfService, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedIOPerformanceLineOfServices(c common2.Client, link string) ([]*IOPerformanceLineOfService, error) { //nolint:dupl
