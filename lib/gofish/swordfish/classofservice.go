...
func (classofservice *ClassOfService) UnmarshalJSON(b []byte) error {
	...
	var t struct {
		temp
		DataProtectionLinesOfService common2.Links
		DataSecurityLinesOfService   common2.Links
		DataStorageLinesOfService    common2.Links
		IOConnectivityLinesOfService common2.Links
		IOPerformanceLinesOfService  common2.Links
	}
...
func GetClassOfService(c common2.Client, uri string) (*ClassOfService, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedClassOfServices(c common2.Client, link string) ([]*ClassOfService, error) { //nolint:dupl
