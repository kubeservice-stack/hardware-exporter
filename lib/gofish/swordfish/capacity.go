...
func (capacitysource *CapacitySource) UnmarshalJSON(b []byte) error {
	...
	var t struct {
		temp
		ProvidedClassOfService common2.Link
		ProvidingDrives        common2.Link
		ProvidingMemory        common2.Link
		ProvidingMemoryChunks  common2.Link
		ProvidingPools         common2.Link
		ProvidingVolumes       common2.Link
	}
...
func GetCapacitySource(c common2.Client, uri string) (*CapacitySource, error) {
	resp, err := c.Get(uri)
	if err != nil {
		return nil, err
	}
...
func ListReferencedCapacitySources(c common2.Client, link string) ([]*CapacitySource, error) {
...
func (capacitysource *CapacitySource) ProvidingDrives() ([]*redfish2.Drive, error) {
	return redfish2.ListReferencedDrives(capacitysource.Client, capacitysource.providingDrives)
}

// ProvidingMemory gets contributing memory.
func (capacitysource *CapacitySource) ProvidingMemory() ([]*redfish2.Memory, error) {
	return redfish2.ListReferencedMemorys(capacitysource.Client, capacitysource.providingMemory)
}
