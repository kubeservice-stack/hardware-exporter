...
import (
	"encoding/json"
	"hardware_exporter/lib/gofish/common"
	redfish2 "hardware_exporter/lib/gofish/redfish"
	swordfish2 "hardware_exporter/lib/gofish/swordfish"
)
...
func (serviceroot *Service) Chassis() ([]*redfish2.Chassis, error) {
	return redfish2.ListReferencedChassis(serviceroot.Client, serviceroot.chassis)
}

// Managers gets the manager instances of this service.
func (serviceroot *Service) Managers() ([]*redfish2.Manager, error) {
	return redfish2.ListReferencedManagers(serviceroot.Client, serviceroot.managers)
}

// StorageSystems gets the storage system instances managed by this service.
func (serviceroot *Service) StorageSystems() ([]*swordfish2.StorageSystem, error) {
	return swordfish2.ListReferencedStorageSystems(serviceroot.Client, serviceroot.storageSystems)
}

// StorageServices gets the Swordfish storage services
func (serviceroot *Service) StorageServices() ([]*swordfish2.StorageService, error) {
	return swordfish2.ListReferencedStorageServices(serviceroot.Client, serviceroot.storageServices)
}

// Tasks gets the system's tasks
func (serviceroot *Service) Tasks() ([]*redfish2.Task, error) {
	return redfish2.ListReferencedTasks(serviceroot.Client, serviceroot.tasks)
}

// CreateSession creates a new session and returns the token and id
func (serviceroot *Service) CreateSession(username, password string) (*redfish2.AuthToken, error) {
	return redfish2.CreateSession(serviceroot.Client, serviceroot.sessions, username, password)
}

// Sessions gets the system's active sessions
func (serviceroot *Service) Sessions() ([]*redfish2.Session, error) {
	return redfish2.ListReferencedSessions(serviceroot.Client, serviceroot.sessions)
}

// DeleteSession logout the specified session
func (serviceroot *Service) DeleteSession(url string) error {
	return redfish2.DeleteSession(serviceroot.Client, url)
}

// AccountService gets the Redfish AccountService
func (serviceroot *Service) AccountService() (*redfish2.AccountService, error) {
	return redfish2.GetAccountService(serviceroot.Client, serviceroot.accountService)
}

// EventService gets the Redfish EventService
func (serviceroot *Service) EventService() (*redfish2.EventService, error) {
	return redfish2.GetEventService(serviceroot.Client, serviceroot.eventService)
}

// Registries gets the Redfish Registries
func (serviceroot *Service) Registries() ([]*redfish2.MessageRegistryFile, error) {
	return redfish2.ListReferencedMessageRegistryFiles(serviceroot.Client, serviceroot.registries)
}

// MessageRegistries gets all the available message registries in all languages
func (serviceroot *Service) MessageRegistries() ([]*redfish2.MessageRegistry, error) {
	return redfish2.ListReferencedMessageRegistries(serviceroot.Client, serviceroot.registries)
}

// MessageRegistry gets a specific message registry.
// uri is the uri for the message registry
func (serviceroot *Service) MessageRegistry(uri string) (*redfish2.MessageRegistry, error) {
	return redfish2.GetMessageRegistry(serviceroot.Client, uri)
}
...
func (serviceroot *Service) MessageRegistriesByLanguage(language string) ([]*redfish2.MessageRegistry, error) {
	return redfish2.ListReferencedMessageRegistriesByLanguage(serviceroot.Client, serviceroot.registries, language)
}
...
// language is the RFC5646-conformant language code for the message registry, for example: "en".
func (serviceroot *Service) MessageRegistryByLanguage(registry, language string) (*redfish2.MessageRegistry, error) {
	return redfish2.GetMessageRegistryByLanguage(serviceroot.Client, serviceroot.registries, registry, language)
}
...
//
// language is the RFC5646-conformant language code for the message registry, for example: "en".
func (serviceroot *Service) MessageByLanguage(messageID, language string) (*redfish2.MessageRegistryMessage, error) {
	return redfish2.GetMessageFromMessageRegistryByLanguage(serviceroot.Client, serviceroot.registries, messageID, language)
}

// Systems get the system instances from the service
func (serviceroot *Service) Systems() ([]*redfish2.ComputerSystem, error) {
	return redfish2.ListReferencedComputerSystems(serviceroot.Client, serviceroot.systems)
}

// CompositionService gets the composition service instance
func (serviceroot *Service) CompositionService() (*redfish2.CompositionService, error) {
	return redfish2.GetCompositionService(serviceroot.Client, serviceroot.compositionService)
}

// UpdateService gets the update service instance
func (serviceroot *Service) UpdateService() (*redfish2.UpdateService, error) {
	return redfish2.GetUpdateService(serviceroot.Client, serviceroot.updateService)
}
